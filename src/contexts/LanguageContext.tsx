...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'press.photoAlt': 'Roberto Zúñiga, cofundador de Simplia Spain, entrevistado ante el micrófono en un estudio de radio',
    ...
    'hero.subtitle3': 'con',
    'hero.subtitle4': 'Agentes e Inteligencia Artificial',
    ...
    'method.step1Desc': 'Generamos leads cualificados para tu negocio mediante agentes de IA y automatizaciones multicanal.',
    'method.step1Badge1': 'Lead Scoring',
    'method.step1Badge2': 'Cualificación Automática',
    'method.step2': 'Paso 2',
    'method.step2Title': 'Atiende a los Clientes',
    'method.step2Desc': 'Proporcionamos los agentes de IA y automatizaciones que atienden a tus clientes 24/7 en todos los canales.',
    ...
    'benefits.our2': 'Datos y conversaciones en servidores de la UE',
    ...
    'services.chatbotsDesc': 'Automatiza tu atención en WhatsApp, Web, Instagram y Telegram con agentes de IA conversacional, también conocidos como chatbots, disponibles 24/7. Captura leads, resuelve dudas y agenda citas automáticamente.',
    ...
    'faq.a1': 'Ofrecemos agentes de IA para WhatsApp, Telegram, Web e Instagram. Cada uno está personalizado para tu negocio y puede manejar consultas, capturar leads y derivar a agentes humanos cuando sea necesario.',
    ...
    'footer.chatbotsWeb': 'Agentes Web',
    ...
    'chatbots.heroDesc': 'Un solo agente con IA, lo que muchos conocen como chatbot, que opera en WhatsApp, Instagram, Telegram y tu web. Captura leads, resuelve dudas y agenda citas automáticamente.',
    ...
    'chatbots.featuresTitle1': 'Un Agente,',
    ...
    'chatbots.feature3Desc': 'Agentes inteligentes para Telegram que gestionan consultas y automatizan procesos.',
    ...
    'chatbots.benefitsDesc': 'Nuestros agentes multicanal están diseñados para capturar leads, cualificarlos y convertirlos en clientes mientras tú te enfocas en lo importante.',
  ...
  en: {
    ...
    'press.photoAlt': 'Roberto Zúñiga, co-founder of Simplia Spain, being interviewed at the microphone in a radio studio',
    ...
    'hero.subtitle3': 'with',
    'hero.subtitle4': 'AI Agents and Automation',
    ...
    'method.step1Desc': 'We generate qualified leads for your business through intelligent AI agents and multichannel automations.',
    'method.step1Badge1': 'Lead Scoring',
    'method.step1Badge2': 'Auto Qualification',
    'method.step2': 'Step 2',
    'method.step2Title': 'Serve Customers',
    'method.step2Desc': 'We provide the AI agents and automations that serve your customers 24/7 across all channels.',
    ...
    'benefits.our2': 'Data and conversations hosted in the EU',
    ...
    'services.chatbotsDesc': 'Automate your support on WhatsApp, Web, Instagram and Telegram with conversational AI agents, also known as chatbots, available 24/7. Capture leads, resolve doubts and schedule appointments automatically.',
    ...
    'faq.a1': 'We offer AI agents for WhatsApp, Telegram, Web and Instagram. Each one is customized for your business and can handle inquiries, capture leads and transfer to human agents when necessary.',
    ...
    'footer.chatbotsWeb': 'Web AI Agents',
    ...
    'chatbots.heroDesc': 'A single AI agent, what most people call a chatbot, that operates on WhatsApp, Instagram, Telegram and your website. Capture leads, resolve doubts and schedule appointments automatically.',
    ...
    'chatbots.featuresTitle1': 'One Agent,',
    ...
    'chatbots.feature3Title': 'Telegram Bot',
    'chatbots.feature3Desc': 'Intelligent agents for Telegram that manage inquiries and automate processes.',
    ...
    'chatbots.benefitsDesc': 'Our multichannel AI agents are designed to capture leads, qualify them and convert them into customers while you focus on what matters.',
